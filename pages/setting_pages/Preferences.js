...
class Preferences extends Component<{}> {
  ...
  render() {
    ...
    let themeOptions = [
      {
        value: appData.appData.screensSettings.preferences.txtThemeHighContrast
      },
      {
        ...
        <View style={stylesData.styles.sharedStyles.contentContainer}>
          ...
          <View style={styles.scalingView}>
            ...
            <Dropdown
              ...
              onChangeText={value => {
                AsyncStorage.setItem('preferences-scale', value.toString());
                this.setState({ scale: value });
                ...
                [
                  {
                    text: 'Cancel',
                    onPress: () => {
                      console.log('dbg.pref.changeLangue: Cancel Pressed');
                    },
                    style: 'cancel'
                  },
                  {
          ...
          <CheckBox
            ...
            onChange={checked => {
              AsyncStorage.setItem('preferences-textOnly', checked.toString());
          ...
          <View style={styles.themeView}>
            ...
            <Dropdown
              ...
              onChangeText={value => {
                AsyncStorage.setItem('preferences-theme', value.toString());
                this.setState({ theme: value });
              }}
            />
          </View>
          <CheckBox
            containerStyle={{ marginLeft: 20 }}
            label={
              appData.appData.screensSettings.preferences.txtLabelShowOutlines
            }
            checked={true}
            onChange={() => {
              // was checked => {
          ...
          <CheckBox
            containerStyle={{ marginLeft: 20 }}
            label={
              appData.appData.screensSettings.preferences.txtLabelNotifications
            }
            checked={false}
            onChange={() => {
              // was: checked => {
          ...
          <CheckBox
            containerStyle={{ marginLeft: 20 }}
            label={
              appData.appData.screensSettings.preferences.txtLabelAutoLaunch
            }
            checked={false}
            onChange={() => {
              // was: checked => {
