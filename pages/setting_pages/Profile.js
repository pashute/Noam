          ...
          <View style={stylesData.styles.sharedStyles.instructionsView}>
            ...
            <View style={stylesData.styles.sharedStyles.inputsView}>
              <TextInput
                ...
                onChangeText={text => {
                  AsyncStorage.setItem('preferences-username', text.toString());
              ...
              <TextInput
                ...
                placeholder={appData.appData.screensSettings.profile.txtEmail}
                onChangeText={text => {
                  AsyncStorage.setItem('preferences-email', text.toString());
              ...
              <TextInput
                ...
                onChangeText={text => {
                  AsyncStorage.setItem('preferences-password', text.toString());
